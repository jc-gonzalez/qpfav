...
QMap<TaskStatus, QString> TaskStatusName = { TLIST_TASK_STATUS };
#undef T

#define T(a,b) { #a , TASK_ ## a }
QMap<QString, TaskStatus> TaskStatusValue = { TLIST_TASK_STATUS };
#undef T
...
const QMap<QString, UserAreaId> UserAreaIdx = { {UserAreaName[UA_NOMINAL], UA_NOMINAL},
